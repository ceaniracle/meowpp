<footer class="footer-custom">
        <div class="container">
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="d-flex align-items-center mb-3 py">
                        <img src="/photo/logo.png" alt="" style="height: 80px;">
                    </div>
                    <p class="small text-gray-400">Topup.bymeowp adalah  Top Up, Jasa Joki & Voucher Game Termurah, Tercepat dan Terpercaya di Indonesia.
                        Proses cepat membuat Anda betah menggunakan Jasa Joki & Top Up disini.
                        Tersedia berbagai macam pembayaran terlengkap yg pasti memudahkan Anda untuk bertransaksi.
                        (OPEN 24 JAM) LANGSUNG PROSES TANPA ANTRI!</p>
                </div>
            ...
            <div class="text-center">
                <p class="text-gray-400 small mb-0">&copy; 2025 Topupbymeowpo All rights reserved.</p>
            </div>
        </div>
    </footer>